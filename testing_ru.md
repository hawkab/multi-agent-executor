...
- `AI Agent` / `pikobot` способен выполнить согласованную техническую задачу и вернуть результат в Jira;
...
```
## 3. Выполнение команд AI Agent внутри контейнера `pikobot`

![Задача для AI Agent](docs/testing/test_devops_agent1.png)

![Результат работы AI Agent](docs/testing/test_devops_agent2.png)

**Сценарий.** В Jira создана техническая задача, в которой AI Agent должен выполнить действия внутри контейнера `pikobot`:
