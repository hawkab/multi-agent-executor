...
from pikobot.agent.tools.mcp import MCPToolWrapper, connect_mcp_servers
from pikobot.agent.tools.registry import ToolRegistry
from pikobot.config.schema import MCPServerConfig
...
async def test_connect_mcp_servers_enabled_tools_warns_on_unknown_entries(
    ...
    monkeypatch.setattr("pikobot.agent.tools.mcp.logger.warning", _warning)
