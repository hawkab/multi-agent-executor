...
def _make_loop(*, exec_config=None):
    ...
    with patch("pikobot.agent.loop.ContextBuilder"), \
         patch("pikobot.agent.loop.SessionManager"), \
         patch("pikobot.agent.loop.SubagentManager") as MockSubMgr:
...
class TestHandleStop:
    ...
    async def test_stop_no_active_task(self):
        ...
        from pikobot.command.builtin import cmd_stop
        from pikobot.command.router import CommandContext
...
class TestSubagentCancellation:
    ...
    async def test_subagent_preserves_reasoning_fields_in_tool_turn(self, monkeypatch, tmp_path):
        from pikobot.agent.subagent import SubagentManager
        from pikobot.bus.queue import MessageBus
        from pikobot.providers.base import LLMResponse, ToolCallRequest
        ...
        monkeypatch.setattr("pikobot.agent.tools.registry.ToolRegistry.execute", fake_execute)
