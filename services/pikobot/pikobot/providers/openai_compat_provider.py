...
if TYPE_CHECKING:
    from pikobot.providers.registry import ProviderSpec
...
_DEFAULT_OPENROUTER_HEADERS = {
    "HTTP-Referer": "https://github.com/hawkab/piko-bot",
    "X-OpenRouter-Title": "pikobot",
...
def _uses_openrouter_attribution(spec: "ProviderSpec | None", api_base: str | None) -> bool:
    """Apply Pikobot attribution headers to OpenRouter requests by default."""
